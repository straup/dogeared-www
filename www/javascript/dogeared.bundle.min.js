...
m=htmlspecialchars(m.url);var f='<div class="document" id="document"';f+=' data-document-id="';f+=htmlspecialchars(l);f+='">';f+='<div class="row">';f+="<h3>";f+=htmlspecialchars(o);f+=" <pre><small>"+m+"</small></pre>";f+="</h3>";f+="</div>";f+='<div class="row">';for(var q in p){f+="<p>";f+=htmlspecialchars(p[q]);f+="</p>"}f+="</div>";f+='<div class="row">';f+=" <pre><small>"+m+"</small></pre>";f+="</div>";f+="<div>";f+='<a href="">reading list</a>';f+="</div>";f+="</div>";$(".excerpt").remove();
