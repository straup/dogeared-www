...
function dogeared_highlights_init_single(){$(".delete-highlight").click(function(){if(!confirm("Are you sure you want to delete this highlight?"))return false;var a={id:$(this).attr("data-highlight-id")};dogeared_api_call("dogeared.highlights.deleteHighlight",a,function(){var b=dogeared_abs_root_url()+"highlights/?deleted=1";location.href=b})})};var notepad_interval=null;function dogeared_notepad_init(){dogeared_notepad_build_list()}function dogeared_notepad_add_note(){var a=Math.uuid(),b=dogeared_now();a={id:a,created:b,lastmodified:0,deleted:0,title:"Untitled Note #"+a,body:"This note left intentionally blank."};b=dogeared_notepad_key(a);store.set(b,a);dogeared_notepad_load_note(b)}
...
5E3);console.log("set interval "+notepad_interval)}function dogeared_notepad_save_note(){if(note=dogeared_notepad_get_current_note()){var a=dogeared_notepad_key(note),b=false,c=$("#note-title");c=c.html();var d=$("#note-body");d=d.html();if(note.title!=c){note.title=c;b=true}if(note.body!=d){note.body=d;b=true}if(b){b=dogeared_now();note.lastmodified=b;console.log("save "+a);store.set(a,note)}else console.log("no updates")}}
...
function dogeared_notepad_close_note(){if(notepad_interval){console.log("clear interval "+notepad_interval);clearInterval(notepad_interval)}dogeared_notepad_save_note();$("#note-editor").hide();dogeared_notepad_build_list()}
function dogeared_notepad_build_list(){var a=$("#note-editor"),b=$("#notes-list"),c="";c+='<li><a href="#" id="note-add">Add a note</a></li>';store.forEach(function(d,f){if(d.split("_")[0]=="notepad"){console.log(f);if(!f.deleted){var e=f.title,j=f.created;c+="<li>";c+='<a href="#" class="note-item" data-note-key="'+d+'">'+e+"</a> ";c+="<small>"+j+"</small>";c+="</li>"}}});b.html(c);$("#note-add").click(function(){dogeared_notepad_add_note();return false});$(".note-item").click(function(){var d=$(this).attr("data-note-key");
