...
function dogeared_api_endpoint(){return document.body.getAttribute("data-api-endpoint")}function dogeared_api_site_token(){return document.body.getAttribute("data-api-site-token")}function dogeared_api_hints_ok(){$("#api-dispatch").hide();$("#api-ok").show();setTimeout(function(){$("#api-ok").hide()},1E4)}function dogeared_api_hints_error(){$("#api-error").show()}function dogeared_api_hints_dispatch(){$("#api-dispatch").show()};function dogeared_extruder_init(){window.addEventListener("offline",function(a){dogeared_extruder_on_offline(a)});window.addEventListener("online",function(a){dogeared_extruder_on_online(a)});$("#fetch").submit(function(){var a=$("#url");a=a.val();dogeared_api_call("dogeared.documents.addDocument",{url:a},function(b){var c=b.document.id;c='Okay! <a href="'+(dogeared_abs_root_url()+"documents/"+c+"/")+'">That document</a> is ready to be dogeared.';dogeared_feedback_ok(c,60);$("#button-dogear").removeAttr("disabled");
...
function dogeared_highlights_schedule_flush(){dogeared_omgwtf("schedule flush");dogeared_highlights_flush&&clearTimeout(dogeared_highlights_flush);if(dogeared_network_is_online()){dogeared_highlights_flush_pending();if(dogeared_network_is_online())dogeared_highlights_flush=setTimeout(function(){dogeared_highlights_schedule_flush()},3E3)}}
function dogeared_highlights_flush_pending(){dogeared_omgwtf("flush pending highlights");for(var a=dogeared_cache_highlights(),b=a.length,c=0;c<b;c++)dogeared_highlights_flush_pending_single(a[c]);a=dogeared_cache_highlights();b=a.length;a=$("#has-pending");b?a.show():a.hide()}
