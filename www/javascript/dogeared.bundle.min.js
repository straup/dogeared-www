...
function dogeared_documents_on_online(){console.log("documents: online")}function dogeared_documents_on_offline(){console.log("documents: offline");dogeared_documents_currently_reading()||dogeared_documents_load_cache()}
...
function dogeared_documents_sort(a){a=usort(a,function(b,c){if(b.created==c.created)return 0;return b.created>c.created?-1:1});return a=array_values(a)}function dogeared_documents_currently_reading(){var a=$("#document").html()?1:0;console.log("currently reading: "+a);return a};var current_selection="";
function dogeared_document_init(){console.log("document init");$(".delete-document").click(function(){if(!dogeared_network_is_online()){alert("Offline deletes are not supported yet.");return false}if(!confirm("Are you sure you want to remove this document?"))return false;var a=$(this).attr("data-document-id");dogeared_api_call("dogeared.documents.deleteDocument",{document_id:a},function(){store.remove("dogeared_"+a);var b=dogeared_abs_root_url()+"documents/";location.href=b})})}
function dogeared_document_init_doc(a){console.log("document init (doc) "+a);dogeared_document_init_highlight_controls();window.onscroll=dogeared_document_on_scroll;var b=dogeared_whosonfirst_get(a);console.log("pos for "+a+" : "+b);b&&window.scrollTo(0,b)}function dogeared_document_on_scroll(){var a=$("#document").attr("data-document-id");a&&dogeared_whosonfirst_set(a,window.scrollY)}
