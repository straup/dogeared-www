...
function dogeared_highlights_init_single(){$(".delete-highlight").click(function(){if(!confirm("Are you sure you want to delete this highlight?"))return false;var a={id:$(this).attr("data-highlight-id")};dogeared_api_call("dogeared.highlights.deleteHighlight",a,function(){var b=dogeared_abs_root_url()+"highlights/?deleted=1";location.href=b})})};var notepad_interval=null,notepad_pending_sync=false;function dogeared_notepad_init(){window.addEventListener("online",dogeared_notepad_on_online);dogeared_notepad_build_list()}function dogeared_notepad_on_online(){notepad_pending_sync&&dogeared_notepad_sync_list()}
...
function dogeared_notepad_sync_list(){if(!dogeared_network_is_online()){notepad_pending_sync=true;return false}notepad_pending_sync=false;console.log("do sync");var a=[];store.forEach(function(c,d){c.split("_")[0]=="notepad"&&a.push(d)});a=JSON.stringify(a);var b={notepad:a};dogeared_api_call("dogeared.notepad.syncNotepad",b,function(c){console.log("sync ok");console.log(c)},function(c){console.log("sync NOT ok");console.log(c)});console.log("dogeared.notepad.syncNotepad");console.log(b)}
