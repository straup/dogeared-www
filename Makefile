...
js:
	...
	java -Xmx64m -jar lib/google-compiler/compiler-20100616.jar --js www/javascript/phpjs.htmlspecialchars.js --js www/javascript/phpjs.usort.js > www/javascript/phpjs.min.js
