...
function dogeared_highlights_schedule_flush(){dogeared_omgwtf("schedule flush");dogeared_highlights_flush&&clearTimeout(dogeared_highlights_flush);if(dogeared_network_is_online()){dogeared_highlights_flush_pending();if(dogeared_network_is_online())dogeared_highlights_flush=setTimeout(function(){dogeared_highlights_schedule_flush()},1E4)}}
function dogeared_highlights_flush_pending(){dogeared_omgwtf("flush pending highlights");for(var a=dogeared_cache_highlights(),b=a.length,c=0;c<b;c++)dogeared_highlights_flush_pending_single(a[c])}
