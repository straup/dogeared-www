...
function dogeared_documents_on_online(){dogeared_omgwtf("documents: online");dogeared_documents_process_to_delete()}function dogeared_documents_on_offline(){dogeared_omgwtf("documents: offline");dogeared_documents_currently_reading()||dogeared_documents_load_cache()}
...
function dogeared_highlights_flush_pending_single(a){if(dogeared_network_is_online()){var b=a.cache_key;dogeared_omgwtf("flush pending highlight "+b);dogeared_api_call("dogeared.highlights.addHighlight",{document_id:a.document_id,text:a.text,created:a.created},function(){store.remove(b);dogeared_cache_highlights_status()})}}
...
function dogeared_highlights_init_single(){$(".delete-highlight").click(function(){if(!confirm("Are you sure you want to delete this highlight?"))return false;var a={id:$(this).attr("data-highlight-id")};dogeared_api_call("dogeared.highlights.deleteHighlight",a,function(){var b=dogeared_abs_root_url()+"highlights/?deleted=1";location.href=b})})}function dogeared_highlights_hints_show(){$("#hint-highlight").show()}function dogeared_highlights_hints_hide(){$("#hint-highlight").hide()};var notepad_interval=null,notepad_inprocess_sync=[],notepad_pending_sync=[];function dogeared_notepad_init(){window.addEventListener("online",dogeared_notepad_on_online);$("#notes-list").html("Wranging your notepad and comparing it to the sky. Tasteful Muzak plays.");dogeared_feedback("Building notes lists.");dogeared_network_is_online()?dogeared_notepad_sync_list():dogeared_notepad_build_list()}
