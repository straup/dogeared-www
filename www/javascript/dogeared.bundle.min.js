...
function dogeared_document_init(){dogeared_document_init_highlight_controls();$(".delete-document").click(function(){if(!dogeared_network_is_online()){alert("Offline deletes are not supported yet.");return false}if(!confirm("Are you sure you want to remove this document?"))return false;var a=$(this).attr("data-document-id");dogeared_api_call("dogeared.documents.deleteDocument",{document_id:a},function(){store.remove("dogeared_"+a);var b=dogeared_abs_root_url()+"documents/";location.href=b})});window.onscroll=
dogeared_document_on_scroll}function dogeared_document_on_scroll(){var a=$("#document");a.attr("data-document-id")&&a.attr("data-scroll-y",window.scrollY)}function dogeared_document_init_highlight_controls(){if(typeof window.ontouchend=="object"){console.log("enable touch based highlight controls");$(document).bind("selectionchange",dogeared_document_selected_selectionchange)}else $(document).bind("mouseup",dogeared_document_selected_mouseup)}
