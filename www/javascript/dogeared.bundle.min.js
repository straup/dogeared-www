function dogeared_init(){$("a").click(function(){if($(this).attr("id")!="reading-list")if(!dogeared_network_is_online())return false});dogeared_network_init();dogeared_appcache_init();dogeared_cache_highlights_init()}function dogeared_abs_root_url(){return document.body.getAttribute("data-abs-root-url")}function dogeared_on_online(){dogeared_feedback("You appear to be online again.");console.log("online")}
...
dogeared_appcache_on_event,false);window.applicationCache.addEventListener("progress",dogeared_appcache_on_event,false);window.applicationCache.addEventListener("updateready",dogeared_appcache_on_updateready,false)}function dogeared_appcache_on_event(a){console.log("appcache event "+a.type)}function dogeared_appcache_on_error(a){console.log("appcache error");console.log(a)}
function dogeared_appcache_on_updateready(){window.applicationCache.status==window.applicationCache.UPDATEREADY&&confirm("A new version of this site is available. Load it?")&&window.location.reload()}function dogeared_appcache_status_code(){return window.applicationCache.status}
