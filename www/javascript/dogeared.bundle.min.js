...
function dogeared_documents_get_text(a){var b=a.document_id;if(b=="0")return false;a={document_id:b,lastmodified:a.lastmodified};console.log(a);dogeared_api_call("dogeared.documents.getInfo",a,function(c){c=c.document;var e=dogeared_cache_documents_store(c);dogeared_omgwtf("store "+c.display_title+" ("+c.id+") "+e);dogeared_documents_fill_cache_decr()},function(){dogeared_documents_fill_cache_decr()});dogeared_documents_fill_cache_incr()}
