...
function dogeared_notepad_build_list(){var a=$("#note-editor"),b=$("#notes-list"),c="";c+='<li><a href="#" id="note-add">Add a note</a></li>';store.forEach(function(d,e){if(d.split("_")[0]=="notepad"){console.log("b "+d+" - "+e.title);e.id||store.remove(d);if(parseInt(e.deleted))console.log(d+" is deleted "+e.deleted);else{var f=e.title,j=e.source_id;c+="<li>";c+='<a href="#" class="note-item" data-note-key="'+d+'">'+f+"</a> ";c+="<small>"+j+"</small>";c+="</li>"}}});b.html(c);$("#note-add").click(function(){dogeared_notepad_add_note();
